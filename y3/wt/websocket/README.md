...
## Docker
Put your source files into a directory, e.g. "nodejs-websocket-example"

Run docker container with this directory in a volume
```
docker run -itd --name mynode -p 3000:3000 -p 40510:40510 -v ${PWD}/nodejs-websocket-example:/nodejs-websocket-example node:stretch npm start --prefix nodejs-websocket-example
```
